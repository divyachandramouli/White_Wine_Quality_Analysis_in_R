...
```
 The distribution of free sulphurdioxide looks skewed to the right. 
...
```
 The bulk of total sulphur dioxide data looks normally distributed with a few outliers on the right
 #### Density
