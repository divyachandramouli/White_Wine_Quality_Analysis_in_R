...
and prepared for analysis. Some distributions were heavily skewed and I used
...
Let's look at the correlation coefficicents (rounded to 2 decimals) for all variables in the dataset
```{r}
corr_coeff <- round(cor(wq),1)
corr_coeff
```



We are most interested in how quality is affected by the physicochemical 
properties 
