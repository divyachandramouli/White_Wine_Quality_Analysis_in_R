...
This data set contains data on white variants of the Portuguese "Vinho Verde" wine. There are 11 variables on quantifying the chemical properties of each wine. At least 3 wine experts rated the quality of each wine, providing a rating between 0 (very bad) and 10 (very excellent).
